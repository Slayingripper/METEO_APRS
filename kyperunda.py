...
def fetchweather():
    ...
    temprature = json['meteorology']['observations'][15]['observation'][0]['observation_value']
    humidity = json['meteorology']['observations'][15]['observation'][8]['observation_value']
    windspeed = json['meteorology']['observations'][15]['observation'][3]['observation_value']
    windirection = json['meteorology']['observations'][3]['observation'][6]['observation_value']
    pressure = json['meteorology']['observations'][3]['observation'][13]['observation_value']
    rain10m = json['meteorology']['observations'][15]['observation'][9]['observation_value']
    rain24h = json['meteorology']['observations'][15]['observation'][9]['observation_value']
