...
def fetchweather():
    ...
    temprature = json['meteorology']['observations'][5]['observation'][0]['observation_value']
    humidity = json['meteorology']['observations'][5]['observation'][9]['observation_value']
    windspeed = json['meteorology']['observations'][5]['observation'][4]['observation_value']
    windirection = json['meteorology']['observations'][5]['observation'][5]['observation_value']
    pressure = json['meteorology']['observations'][5]['observation'][11]['observation_value']
    rain10m = json['meteorology']['observations'][5]['observation'][10]['observation_value']
    rain24h = json['meteorology']['observations'][5]['observation'][10]['observation_value']
...
def sendmypacket(WINDDIRECTION,WINDSPEED,TEMP,HUMIDITY,PRESSURE,RAIN10,RAIN24):
	...
	AIS.sendall("5B4NC-WX>APDR15,WIDE1-1:=3497.1 N/""03407.0 E_"+WINDDIRECTION+"/0"+WINDSPEED+"g000t"+TEMP+"r00"+RAIN10+"p00"+RAIN24+"P000h"+HUMIDITY+"b"+PRESSURE+"L000")
